window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const THEMES = {
			blue:   { name: "蓝", bg: "#f5f8ff", accent: "#60a5fa" },
			purple: { name: "紫", bg: "#faf5ff", accent: "#a78bfa" },
			gray:   { name: "灰", bg: "#f9fafb", accent: "#9ca3af" },
			white:  { name: "白", bg: "#fcfcfc", accent: "#e5e7eb" },
			green:  { name: "绿", bg: "#f6fdf9", accent: "#6ee7b7" },
			red:    { name: "红", bg: "#fffbfb", accent: "#fca5a5" }
		};
