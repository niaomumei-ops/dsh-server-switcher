	...
	factory: (require) => {
		...
		function mount() {
			...
			panel.innerHTML = srvHTML
				...
				+ '<div class="sw-div"></div>'
				+ '<a href="https://xmbot.top/omni.html" target="_blank" class="sw-link" style="font-size:11px;background:rgba(99,102,241,.2);border:1px solid rgba(99,130,255,.3)" title="千面管理面板">🧭 总控</a>';
