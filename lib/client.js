	...
	factory: (require) => {
		...
		function mount() {
			...
			style.textContent = `
				...
				.sw-restart:hover .sw-restart-icon { animation: spin 0.8s linear; }
				.sw-restart-icon { font-size: 13px; }
			`;
			...
			panel.innerHTML = srvHTML
				...
				+ dotHTML
				+ '<div class="sw-div"></div>'
				+ '<button class="sw-restart" id="dsh-sw-restart" title="重启 DSH 服务"><span class="sw-restart-icon">⏻</span> 重启</button>';
